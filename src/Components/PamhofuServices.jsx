      ...
      <div style={S.modal}>
        ...
        <div style={{padding:"24px"}}>
          ...
          <div style={{display:"flex", alignItems:"center", gap:"12px", marginBottom:"24px"}}>
            <button
              style={{...S.btnOutline, padding:"8px 16px", fontSize:"18px"}}
            ...
            {service && (
              <div style={{
                marginLeft:"auto", background:`linear-gradient(135deg, ${C.purple}, ${C.purpleMid})`,
          ...
          <div style={{display:"flex", justifyContent:"flex-end", marginTop:"8px"}}>
            <button style={S.btnGold} disabled={!selected}>
              Submit Booking →
            </button>
          </div>
        </div>
...
function ButcheryModal({ onClose }) {
  const [cart, setCart] = useState({});   // name → kg
          ...
          <div style={{flex:"1 1 340px"}}>
            ...
            <div style={{display:"flex", gap:"8px", marginBottom:"16px"}}>
              {MEAT_CATALOGUE.map(c => (
                <button key={c.category}
                  style={S.pill(activeTab === c.category)}
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span>Cut</span><span style={{textAlign:"center"}}>$/kg</span>
              ...
              {activeItems.map((item, i) => {
                ...
                return (
                  <div key={item.name} style={{
                    ...
                    borderBottom: i < activeItems.length-1
                      ? `1px solid ${C.darkBorder}` : "none",
...
// Rough Harare suburb distances to Pamhofu (plot 604 Rainham Rd, west Harare) in km
const LOCATIONS = [
      ...
      <div style={{...S.modal, maxWidth:"780px"}}>
        ...
        <div style={{padding:"24px"}}>
          ...
          <div style={{display:"flex", gap:"12px", marginBottom:"24px", flexWrap:"wrap"}}>
            {TRANSPORT_TYPES.map(t => (
              <div key={t.key} onClick={() => setType(t.key)} style={{
                ...
                <div style={{fontSize:"12px", color: type===t.key ? C.goldLight : C.textMuted,
                             marginTop:"3px"}}>
                  ${t.ratePerKm}/km/head
                </div>
              </div>
          ...
          <div style={{display:"flex", justifyContent:"flex-end", marginTop:"16px"}}>
            <button
              style={{...S.btnGold,
                      opacity: type && pickup ? 1 : 0.5,
                      cursor: type && pickup ? "pointer" : "not-allowed"}}
...
// ─── SERVICES SECTION (the component to drop into your page) ──────
export default function ServicesSection() {
  const [modal, setModal] = useState(null);  // "abattoir" | "butchery" | "transport"
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            { id:"abattoir",  icon:"🔪", title:"Abattoir Service",
              sub:"Cattle · Pig · Goat" },
            { id:"butchery",  icon:"🥩", title:"Butchery",
              sub:"Fresh cuts & meats" },
            { id:"transport", icon:"🚛", title:"Transport / Delivery",
              sub:"Farm to table" },
          ].map((s, i) => (
            <QuickTab key={s.id} {...s}
              divider={i < 2}
      ...
      {/* ── Cards (larger visual section below) ─────────────── */}
      <div style={{
